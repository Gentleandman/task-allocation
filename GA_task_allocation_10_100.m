...
% evaluate fitness
        ...
        for z=1:(Num_AUV-1)
            offspring1(Num_AUV+1)=offspring1(Num_AUV+1)+B(floor(z/10+1),offspring1(1,z));
        end
        offspring1(Num_AUV+1)=offspring1(Num_AUV+1)+B(10,offspring1(1,100));
        for z=1:(Num_AUV-1)
            offspring2(Num_AUV+1)=offspring2(Num_AUV+1)+B(floor(z/10+1),offspring2(1,z));
        end        
        offspring2(Num_AUV+1)=offspring2(Num_AUV+1)+B(10,offspring2(1,100));
...
% Evaluate fitness of mutateed members
        parent(Num_AUV+1)=0;
        for z=1:(Num_AUV-1)
            parent(Num_AUV+1)=parent(Num_AUV+1)+B(floor(z/10+1),parent(1,z));
        end
        parent(Num_AUV+1)=parent(Num_AUV+1)+B(10,parent(1,100));
...
best_root=pop(1,1:100);
min_distance=pop(1,101);
toc